            ...
            <div className="relative flex justify-between h-[43rem] max-w-[89rem] mx-auto  ">
                ...
                <div className="mt-20">
                    ...
                    <div className="flex flex-col ">
                        <p className="text-clamp text-text_100">We Take Care of</p>
                        <p className="text-6xl text-text_100">Your Mental Health</p>
                        <p className="w-[32rem] mt-6 text-text_60 text-xl">Embark on a journey to better well-being with our team of dedicated professionals.
                ...
                <div className="absolute -bottom-10 bg-background  rounded-lg left-1/2 transform -translate-x-1/2 w-full h-[8rem] shadow px-40 flex justify-between">
