    ...
    return (
        <div className="flex items-start justify-between  w-[75rem] mx-auto  mt-32 pb-32">
            <div>
                ...
                <div>
                    <h2 className="text-4xl font-bold text-black/80 pb-2 mt-2 max-w-[30rem]">Book today an appointment</h2>
                    <h2 className="text-4xl font-bold text-black/80 max-w-[30rem] ">through our platform!</h2>

                    <p className="text-xl  text-black/60 max-w-[30rem] mt-6">On our platform, effortlessly book appointments with specialists tailored to your needs, ensuring a comfortable reservation process for you.</p>
                </div>
