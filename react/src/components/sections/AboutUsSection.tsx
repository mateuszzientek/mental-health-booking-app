...
export default function AboutUsSection() {
    return (
        <div className="bg-background">
            <div className="relative flex items-center justify-between w-[75rem] mx-auto pb-32 bg-background">
